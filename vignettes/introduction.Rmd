...
This example outlines the analysis performed in [Spiller et al. (2021)](https://psyarxiv.com/g4kf8/) using sample data also include in the same publication.
...
```{r , echo=TRUE}
desc_freq <- describe_pheno_distr(freq_distribution, bootStrap = T, nBoots = 5, nCores = 1)
```
